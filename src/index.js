...
import { getAntonymAbi, getMateriaAbi, getNetwork, getSkin1of1Tokens, readError } from './materia-functions';
...
class App extends Component {
    constructor() {
        ...
        this.state = {
            ...
            error: null,
            networkId: 1,
            materia: "0xB822403ecD5481E7abC061A0B2565F969C492064",
    ...
    async componentDidUpdate(_, prevState, __) {
        ...
        if (!prevState.antonymContract && antonymContract) {
            ...
            setTimeout(() => this.setState({ fetched: true }), 2000);
    ...
    async enableWeb3() {
        ...
        try {
            ...
            ethereum.on('chainChanged', async (network) => {
                location.reload()
            })
